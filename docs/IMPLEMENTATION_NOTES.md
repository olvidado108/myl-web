...
**IMPORTANTE**: Todas las funcionalidades deben implementarse como APIs REST primero.

- ✅ Lógica de negocio en el servidor
- ✅ Cliente web consume APIs (no lógica directa)
- ✅ Misma API sirve para web, Android, iOS, etc.
