...
1. **PROGRESS.md** - Estado actual del proyecto, qué está completado y qué falta
2. **ROADMAP.md** - Plan detallado de lo que se debe hacer en cada fase
3. **BUGS.md** - Bugs conocidos que necesitan atención
4. **IMPROVEMENTS.md** - Mejoras sugeridas
...
1. **NUNCA** trabajar directamente en `main` (excepto para merges)
2. **SIEMPRE** actualizar la documentación cuando hagas cambios
3. **SIEMPRE** hacer commits descriptivos
4. **SIEMPRE** revisar `PROGRESS.md` antes de empezar a trabajar
5. **SIEMPRE** preguntar al usuario si algo no está claro
